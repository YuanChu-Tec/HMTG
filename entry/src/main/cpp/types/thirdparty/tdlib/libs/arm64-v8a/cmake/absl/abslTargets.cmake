...
set_target_properties(absl::base PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::atomic_hook;absl::base_internal;absl::config;absl::core_headers;absl::dynamic_annotations;absl::log_severity;absl::nullability;absl::raw_logging_internal;absl::spinlock_wait;absl::type_traits;Threads::Threads;\$<LINK_ONLY:\$<\$<BOOL:C:/Users/28483/AppData/Local/OpenHarmony/Sdk/20/native/sysroot/usr/lib/aarch64-linux-ohos/librt.a>:-lrt>>;\$<LINK_ONLY:\$<\$<BOOL:>:-ladvapi32>>"
)
...
# Create imported target absl::heterogeneous_lookup_testing
add_library(absl::heterogeneous_lookup_testing INTERFACE IMPORTED)

set_target_properties(absl::heterogeneous_lookup_testing PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::test_instance_tracker;GTest::gmock"
)
