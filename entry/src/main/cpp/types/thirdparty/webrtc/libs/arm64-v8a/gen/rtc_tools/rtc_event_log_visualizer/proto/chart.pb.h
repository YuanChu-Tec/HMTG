...
class TickLabel final :
 ...
 public:
  ...
  ~TickLabel() override;
  explicit PROTOBUF_CONSTEXPR TickLabel(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TickLabel* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class Chart final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_xaxis_label(ArgT0&& arg0, ArgT... args);
  std::string* mutable_xaxis_label();
  PROTOBUF_NODISCARD std::string* release_xaxis_label();
  void set_allocated_xaxis_label(std::string* xaxis_label);
  private:
  const std::string& _internal_xaxis_label() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_xaxis_label(const std::string& value);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_yaxis_label(ArgT0&& arg0, ArgT... args);
  std::string* mutable_yaxis_label();
  PROTOBUF_NODISCARD std::string* release_yaxis_label();
  void set_allocated_yaxis_label(std::string* yaxis_label);
  private:
  const std::string& _internal_yaxis_label() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_yaxis_label(const std::string& value);
...
class ChartCollection final :
 ...
 public:
  ...
  ~ChartCollection() override;
  explicit PROTOBUF_CONSTEXPR ChartCollection(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ChartCollection* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
void DataSet::set_label(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TickLabel::set_label(ArgT0&& arg0, ArgT... args) {
...
inline ::webrtc::analytics::DataSet* Chart::add_data_sets() {
  ::webrtc::analytics::DataSet* _add = _internal_add_data_sets();
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Chart::set_xaxis_label(ArgT0&& arg0, ArgT... args) {
 
 xaxis_label_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Chart::set_allocated_xaxis_label(std::string* xaxis_label) {
  ...
  xaxis_label_.SetAllocated(xaxis_label, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (xaxis_label_.IsDefault()) {
    xaxis_label_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Chart::set_yaxis_label(ArgT0&& arg0, ArgT... args) {
 
 yaxis_label_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Chart::set_allocated_yaxis_label(std::string* yaxis_label) {
  ...
  yaxis_label_.SetAllocated(yaxis_label, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (yaxis_label_.IsDefault()) {
    yaxis_label_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Chart::set_id(ArgT0&& arg0, ArgT... args) {
...
inline ::webrtc::analytics::TickLabel* Chart::add_yaxis_tick_labels() {
  ::webrtc::analytics::TickLabel* _add = _internal_add_yaxis_tick_labels();
...
inline ::webrtc::analytics::Chart* ChartCollection::add_charts() {
  ::webrtc::analytics::Chart* _add = _internal_add_charts();
